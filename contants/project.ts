...
export const projects: Project[] = [
    {
        ...
        title: "Chat with PDF",
        description:
            "An AI-powered PDF chatbot that allows users to upload and interact with PDF documents.",
        image: pdfchat1,
        tags: [
    ...
    },
    {
        ...
        title: "Cozera Store",
        description:
            "A full-featured e-commerce platform with cart, checkout, and dashboard functionalities.",
        image: cozera1,
        tags: [
    ...
    },
    {
        ...
        title: "Logo AI",
        description:
            "An AI-powered logo generator use advanced algorithms for design generation.",
        image: logoai1,
        tags: [
            { icon: nextjs, name: "Next.js" },

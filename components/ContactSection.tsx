...
export default function ContactSection() {
    return (
        <div className="w-full mt-15">
            ...
            <div className="bg-[#d4d4d434] dark:bg-[#27272B66] shadow-md  rounded-xl p-6 px-8">
                <div className="flex items-center gap-4 mb-2">
                    {/* Purple rocket icon */}
                    <div className="shrink-0">
                        <div className="w-10 h-10 bg-[#d4d4d434] dark:bg-[#27272B66] rounded-lg flex items-center justify-center border">

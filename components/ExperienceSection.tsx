...
const responsibilitiesAsFreelancer: string[] = [
    "Developed and maintained web applications for diverse clients using React and Next.js.",
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="space-y-6 mt-[-5px]">
                            <div>
                                ...
                                <ul className="list-disc ml-5 flex flex-col gap-1 text-foreground/80 ">
